...
public class XPathAxesDemo {
	...
	private static void navigate()
	{
		try
		{
			oBrowser.get("file:///C:/Users/Sharana%20Basava/Desktop/HTML/WebTableHTML.html");
			Thread.sleep(4000);
		}catch(Exception e)
		{
			e.printStackTrace();
	...
	//	oBrowser.findElement(By.xpath("//td[text()='Sachin Tendulkar']/following-sibling::td/following-sibling::td/following-sibling::td/following-sibling::td/input")).sendKeys("25000");
		oBrowser.findElement(By.xpath("//td[text()='Sachin Tendulkar']/following-sibling::td[4]/input")).sendKeys("78000");
	}
