...
public class Scenario6 {
	...
	private static void createCustomer()
	{
		try {
			...
			Thread.sleep(2000);
			o.findElement(By.id("customerLightBox_nameField")).sendKeys("Customer111222");
	...
	private static void modifyProject()	
	{
		try {
			...
			Thread.sleep(4000);
			o.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[1]/div[2]/div[2]/div/div[2]/input")).clear();
			Thread.sleep(2000);
			o.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[1]/div[2]/div[2]/div/div[2]/input")).sendKeys("Project123456");
			Thread.sleep(2000);
			o.findElement(By.xpath("//*[@id=\"cpTreeBlock\"]/div[2]/div[2]/div/div[2]/div/div[1]/div[2]/div[3]/div[3]")).click();
			Thread.sleep(2000);
